class SwigAT402 < Formula
  ...
  # NOTE: see my github issue, config script does not have +x bit set swig.exp2 branch
  ...
  bottle do
    ...
    rebuild 3
    sha256 mojave: "7ed4b1104473a2be1a4be0c247525bf0b4cbf86a36bc09612e0daeccecc15b28"
  end
